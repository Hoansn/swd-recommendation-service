package com.example.swd.thrift;
...
// @Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2023-03-06")
public class TRecommendService {
  ...
  public interface Iface {
    ...
    public List<Integer> getRecommendation(int userId, int targetId) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getRecommendation(int userId, int targetId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<Integer> getRecommendation(int userId, int targetId) throws org.apache.thrift.TException
    {
      send_getRecommendation(userId, targetId);
      return recv_getRecommendation();
    }

    public void send_getRecommendation(int userId, int targetId) throws org.apache.thrift.TException
    {
    ...
    public List<Integer> recv_getRecommendation() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getRecommendation(int userId, int targetId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getRecommendation_call method_call = new getRecommendation_call(userId, targetId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getRecommendation_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int userId;
      private int targetId;
      public getRecommendation_call(int userId, int targetId, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getRecommendation<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getRecommendation_args> {
      ...
      public getRecommendation_result getResult(I iface, getRecommendation_args args) throws org.apache.thrift.TException {
        getRecommendation_result result = new getRecommendation_result();
        result.success = iface.getRecommendation(args.userId, args.targetId);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getRecommendation<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getRecommendation_args, List<Integer>> {
      public getRecommendation() {
        super("getRecommendation");
      }
      ...
      public void start(I iface, getRecommendation_args args, org.apache.thrift.async.AsyncMethodCallback<List<Integer>> resultHandler) throws TException {
        iface.getRecommendation(args.userId, args.targetId,resultHandler);
      }
    }
...
;
  ...
  public static class getRecommendation_args implements org.apache.thrift.TBase<getRecommendation_args, getRecommendation_args._Fields>, java.io.Serializable, Cloneable, Comparable<getRecommendation_args>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getRecommendation_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getRecommendation_argsTupleSchemeFactory());
    }
    ...
    public getRecommendation_args setTargetId(int targetId) {
      this.targetId = targetId;
      setTargetIdIsSet(true);
      return this;
    }
    ...
    private static class getRecommendation_argsStandardSchemeFactory implements SchemeFactory {
      public getRecommendation_argsStandardScheme getScheme() {
        return new getRecommendation_argsStandardScheme();
      }
    }

    private static class getRecommendation_argsStandardScheme extends StandardScheme<getRecommendation_args> {
    ...
    private static class getRecommendation_argsTupleSchemeFactory implements SchemeFactory {
      public getRecommendation_argsTupleScheme getScheme() {
        return new getRecommendation_argsTupleScheme();
      }
    }

    private static class getRecommendation_argsTupleScheme extends TupleScheme<getRecommendation_args> {
  ...
  public static class getRecommendation_result implements org.apache.thrift.TBase<getRecommendation_result, getRecommendation_result._Fields>, java.io.Serializable, Cloneable, Comparable<getRecommendation_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getRecommendation_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getRecommendation_resultTupleSchemeFactory());
    }
    ...
    public getRecommendation_result setSuccess(List<Integer> success) {
      this.success = success;
      return this;
    }
    ...
    private static class getRecommendation_resultStandardSchemeFactory implements SchemeFactory {
      public getRecommendation_resultStandardScheme getScheme() {
        return new getRecommendation_resultStandardScheme();
      }
    }

    private static class getRecommendation_resultStandardScheme extends StandardScheme<getRecommendation_result> {
    ...
    private static class getRecommendation_resultTupleSchemeFactory implements SchemeFactory {
      public getRecommendation_resultTupleScheme getScheme() {
        return new getRecommendation_resultTupleScheme();
      }
    }

    private static class getRecommendation_resultTupleScheme extends TupleScheme<getRecommendation_result> {
